...
export const setting_green_btn = "bg-[#2a870b] shadow-sm hover:bg-[#2a870b]/60 text-white hover:text-white";


export const sideBarTrigger = "flex w-full items-center gap-5 text-foreground hover:bg-transparent md:text-2xl"
...
export const pageContainer = "flex flex-1 flex-col  pt-0"

export const settingGBtn = "w-[225px] self-end rounded-lg bg-[#2a870b] shadow-sm hover:bg-[#2a870b]/60 text-white"

export const cardHeader = "px-0 pb-7 pt-0 text-xl md:text-2xl lg:text-3xl"
...
export const settingCard = "flex w-full max-h-[100%] shrink-0 snap-center flex-col overflow-y-auto p-6 text-card-foreground scrollbar h-fit";



export const headerButton = "flex items-center gap-2 p-0 hover:bg-transparent"
export const setSetLogo = "flex flex-col gap-2"
export const imgDiv = "flex flex-row items-center gap-2"
export const setSetLogoText = "text-2xl font-semibold text-secondary"

export const headerSection = "flex w-full items-center justify-between px-4"
//for faq icon styles in sample data
export const iconStyles ="text-secondary h-10 w-10 rounded-lg p-2"
...
export const settingHeader = "px-0 pb-4 pt-0 text-xl md:text-2xl lg:text-3xl"
