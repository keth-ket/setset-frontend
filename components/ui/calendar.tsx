...
function Calendar({
  ...
  const _monthClassName = cn("sm:w-full w-fit p-1", props.monthClassName);
  ...
  const _rangeMiddleClassName = cn(
    "bg-accent !text-primary [&>button]:!bg-accent [&>button]:!text-secondary [&>button]:hover:bg-transparent [&>button]:hover:!text-foreground",
    props.rangeMiddleClassName,
  );
  const _selectedClassName = cn(
    "[&>button]:bg-secondary [&>button]:text-primary [&>button]:hover:bg-secondary [&>button]:hover:text-primary",
